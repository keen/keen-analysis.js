...
function sendFetch(method, config) {
  ...
  if (typeof AbortController !== 'undefined') {
    options.request.abortController = new AbortController();
  }
  ...
  return fetch(url, {
    ...
    mode: 'cors',
    headers: headers,
    signal: options.request.abortController ? options.request.abortController.signal : undefined
...
var _httpBrowser = __webpack_require__(9);
